...
namespace FileSort
{
    public partial class Form1 : Form
    {
        ...
        private void CreateEndFolders()
        {
            ...
            if (!Directory.Exists(Var.EndDirectory + @"\Ordner"))
                Directory.CreateDirectory(Var.EndDirectory + @"\Ordner");

            if (!Directory.Exists(Var.EndDirectory + @"\Rest"))
                Directory.CreateDirectory(Var.EndDirectory + @"\Rest");
        }
